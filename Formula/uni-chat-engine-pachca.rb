class UniChatEnginePachca < Formula
  ...
  if artifact
    ...
    url "https://github.com/MikcleGrok/tools/releases/download/v1.1.30/uni-chat-engine-pachca-1.1.30-darwin-arm64.tar.gz"
    sha256 "ac4bcf712ae374053a664d6e9dea605843f6543fc29581639c8dab7ee39da40c"
  end
  depends_on :macos
